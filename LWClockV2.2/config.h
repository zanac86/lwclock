...
String cVersion = nName + nVersion + urts;
...
String jsonConfig = "{}";
uint8_t lang = 0; //0-RU, 1-BG, 2 -EN, 3-UA
...
String  W_API    = "565281bd3aa6226bb94f142ed0ba05f1";
String  CITY_ID     = "546230"; // Other city code http://bulk.openweathermap.org/sample/city.list.json.gz
...
unsigned long lastTimeWeatherFcast = 0, lastTimeSea = 0;
